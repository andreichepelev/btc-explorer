...
module.exports = "<div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-md-8\">\n        <h1>PumaPay Bitcoin Block Explorer</h1>\n        <br />\n        <p>This service, powered by BlockBook API, allows you to monitor Bitcoin blockchain and retrieve data per each mined block, executed transaction or address.</p>\n        <br />\n        <table class=\"table table-hover\">\n          <tbody>\n            <tr>\n              <th scope=\"row\">Current Bitcoin price</th>\n              <td>{{ btcusdprice?.rate | number }} USD</td>\n            </tr>\n            <tr>\n                <th scope=\"row\"></th>\n                <td>{{ btcethprice?.rate | number }} ETH</td>\n              </tr>\n            <tr>\n               <tr>\n                  <th scope=\"row\"></th>\n                  <td>{{ btcpmaprice?.rate | number }} PMA</td>\n               </tr>\n            <tr>\n            <tr>\n              <th scope=\"row\">Last price update</th>\n              <td>{{ btcusdprice?.time | date:'long' }}</td>\n            </tr>\n            <tr>\n              <th scope=\"row\">Price source</th>\n              <td><a href=\"https://coinapi.io\">CoinAPI</a></td>\n            </tr>\n            <tr>\n                <th scope=\"row\">Latest mined blocks</th>\n                <td><a href=\"/blocks/{{ general?.bestHeight }}\" target=\"_blank\">{{ general?.bestHeight }}</a>,\n                  <a href=\"/blocks/{{ general?.bestHeight-1 }}\" target=\"_blank\">{{ general?.bestHeight-1 }}</a>,\n                  <a href=\"/blocks/{{ general?.bestHeight-2 }}\" target=\"_blank\">{{ general?.bestHeight-2 }}</a>,\n                  <a href=\"/blocks/{{ general?.bestHeight-3 }}\" target=\"_blank\">{{ general?.bestHeight-3 }}</a>,\n                  <a href=\"/blocks/{{ general?.bestHeight-3 }}\" target=\"_blank\">{{ general?.bestHeight-4 }}</a>\n                </td>\n              </tr>\n              <tr>\n                <th scope=\"row\">Last block update</th>\n                <td>{{ general?.lastBlockTime | date:'long' }}</td>\n              </tr>\n              <tr>\n                <th scope=\"row\">Host</th>\n                <td>{{ general?.host }}</td>\n              </tr>\n              <tr>\n                <th scope=\"row\">Blockbook version</th>\n                <td>{{ general?.version }}</td>\n              </tr>\n              <tr>\n                <th scope=\"row\">Mempool size</th>\n                <td>{{ general?.mempoolSize }}</td>\n              </tr>\n              <tr>\n                <th scope=\"row\">Last mempool update</th>\n                <td>{{ general?.lastMempoolTime | date:'long' }}</td>\n              </tr>\n          </tbody>\n        </table>\n      </div>\n    </div>\n</div>\n"
...
module.exports = "table {\r\n  border-collapse: collapse;\r\n  max-width: 100%;\r\n}\r\n\r\n.is-overflow-ellipsis {\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  max-width: 1px;\r\n  width: 100%;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
let AddressComponent = class AddressComponent {
    constructor(activatedRoute, exService) {
...
module.exports = "table {\r\n  border-collapse: collapse;\r\n  max-width: 100%;\r\n}\r\n\r\n.is-overflow-ellipsis {\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  max-width: 1px;\r\n  width: 70%;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
let BlockHistoryComponent = class BlockHistoryComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
module.exports = "table {\r\n  border-collapse: collapse;\r\n  max-width: 100%;\r\n}\r\n\r\n.is-overflow-ellipsis {\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  max-width: 1px;\r\n  width: 100%;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
let BlockSummaryComponent = class BlockSummaryComponent {
    constructor(activatedRoute, exService) {
        this.activatedRoute = activatedRoute;
        this.exService = exService;
...
BlockSummaryComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _explorer_service__WEBPACK_IMPORTED_MODULE_3__["ExplorerService"] }
];
...
let ExplorerService = class ExplorerService {
    ...
    fetchBtcUsdPrice() {
        return this.http.get('https://rest.coinapi.io/v1/exchangerate/BTC/USD?apikey=6BEBC0FD-FCC0-4E1E-8E54-200BCCD66672');
    }
    fetchBtcEthPrice() {
        return this.http.get('https://rest.coinapi.io/v1/exchangerate/BTC/ETH?apikey=6BEBC0FD-FCC0-4E1E-8E54-200BCCD66672');
    }
    fetchBtcPmaPrice() {
        return this.http.get('https://rest.coinapi.io/v1/exchangerate/BTC/PMA?apikey=6BEBC0FD-FCC0-4E1E-8E54-200BCCD66672');
    }
    fetchGeneral() {
        return this.http.get('http://142.93.172.157:9000/blockbook/btc/main/v2').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
...
module.exports = "table {\r\n  border-collapse: collapse;\r\n  max-width: 100%;\r\n}\r\n\r\n.is-overflow-ellipsis {\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n  overflow: hidden;\r\n  max-width: 1px;\r\n  width: 100%;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
